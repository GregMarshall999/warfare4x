...
public final class PerlinNoise
{
    ...
    static {
        ...
        permutation = new int[] {
                ...
                135, 130, 116, 188, 159, 86, 164, 100, 109, 198, 173, 186, 3, 64, 52, 217, 226, 250, 124, 123, 5, 202,
                ...
                157, 184, 84, 204, 176, 115, 121, 50, 45, 127, 4, 150, 254, 138, 236, 205, 93, 222, 114, 67, 29, 24,
    ...
    /**
     * Generates 2D noise value at x and y coordinate
     * Follows the Perlin algorithm
    ...
    public static double noise(double x, double y) {
        ...
        while (size >= 1) {
            value += smoothNoise(x/size, y/size, 0/size) * size;
            size /= 2.0;
        }
    ...
    private static double smoothNoise(double x, double y, double z) {
        x += seed;
        y += seed;
        z += seed;
